...
export default function Home() {
  return (
    <>
      {/* Hero Section */}
      <section className="w-screen md:min-h-dvh flex md:flex-row flex-col md:gap-24 gap-6 bg-secondary md:px-36 px-4 md:pb-24 p-8">
        <motion.div
      ...
      {/* Info Section */}
      <motion.section
        className="w-screen md:min-h-dvh bg-primary p-8 md:px-36 md:py-24"
        id="info"
        initial={{ opacity: 0 }}
      ...
      >
        ...
        <div className="flex flex-col md:hidden gap-8">
          <h1 className="font-serif text-secondary italic text-2xl">
          ...
          <motion.div
            ...
            transition={{ duration: 1, delay: 0.3 }}
          >
            <h2 className="font-serif text-secondary text-xl font-bold">
        ...
        {/* Desktop Layout */}
        <div className="hidden md:grid md:grid-rows-2 md:grid-cols-2 md:gap-6">
          <div className="row-start-1 col-start-1 items-start">
            <h1 className="font-serif text-secondary italic md:text-4xl">
              A highly collaborative web developer with a technical background + an eye for detail
            </h1>
          </div>
          ...
          <motion.div
            ...
            transition={{ duration: 1, delay: 0.3 }}
          >
            <h2 className="font-serif text-secondary md:text-3xl font-normal font-bold">
              I strongly believe in communication + collaboration as the most effective solution
            </h2>
            <p className="font-sans text-secondary text-lg leading-relaxed">
              In today&apos;s world, most answers can be found with AI or a quick internet search.
      ...
      {/* Project Section */}
      <motion.section
        className="w-screen md:min-h-dvh bg-secondary md:py-24 md:px-36 p-12"
        id="projects"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: false }}
      ...
      {/* Contact Section */}
      <motion.section
        className="w-screen md:min-h-dvh bg-primary p-12 md:px-36 md:py-36"
        id="connect"
        initial={{ opacity: 0 }}
        whileInView={{ opacity: 1 }}
        viewport={{ once: true }}
      ...
      >
          ...
          >
            ...
            <div className="flex flex-row gap-4 items-baseline">
              ...
              <h1 className="font-sans text-secondary text-lg leading-relaxed">
                <a
                  href="mailto:khgonzalez0@gmail.com"
        ...
        {/* Desktop Layout */}
        <div className="hidden md:grid md:grid-rows-2 md:grid-cols-2 md:gap-8">
          {/* Top-left: Heading */}
          <div className="row-start-1 col-start-1 flex items-start">
            <h1 className="font-serif text-secondary italic font-bold md:text-6xl">
              Let&apos;s connect
            </h1>
          </div>
